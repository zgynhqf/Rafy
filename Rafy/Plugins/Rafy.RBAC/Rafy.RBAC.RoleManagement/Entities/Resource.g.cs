...
namespace Rafy.RBAC.RoleManagement
{
    ...
    partial class ResourceRepository
    {
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new Resource GetById(object id, LoadOptions loadOptions = null)
        {
            return base.GetById(id, loadOptions) as Resource;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new Resource GetFirst(LoadOptions loadOptions = null)
        {
            return base.GetFirst(loadOptions) as Resource;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new ResourceList GetAll(PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetAll(paging, loadOptions) as ResourceList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new ResourceList GetByIdList(object[] idList, LoadOptions loadOptions = null)
        {
            return base.GetByIdList(idList, loadOptions) as ResourceList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new ResourceList GetByParentIdList(object[] parentIdList, PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetByParentIdList(parentIdList, paging, loadOptions) as ResourceList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new ResourceList GetByParentId(object parentId, PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetByParentId(parentId, paging, loadOptions) as ResourceList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new ResourceList GetByTreeParentIndex(string treeIndex, LoadOptions loadOptions = null)
        {
            return base.GetByTreeParentIndex(treeIndex, loadOptions) as ResourceList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new ResourceList GetByTreePId(object treePId, LoadOptions loadOptions = null)
        {
            return base.GetByTreePId(treePId, loadOptions) as ResourceList;
        }
