...
namespace Rafy.Accounts
{
    ...
    partial class UserRepository
    {
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new User GetById(object id, LoadOptions loadOptions = null)
        {
            return base.GetById(id, loadOptions) as User;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new User GetFirst(LoadOptions loadOptions = null)
        {
            return base.GetFirst(loadOptions) as User;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new UserList GetAll(PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetAll(paging, loadOptions) as UserList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new UserList GetByIdList(object[] idList, LoadOptions loadOptions = null)
        {
            return base.GetByIdList(idList, loadOptions) as UserList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new UserList GetByParentIdList(object[] parentIdList, PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetByParentIdList(parentIdList, paging, loadOptions) as UserList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new UserList GetByParentId(object parentId, PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetByParentId(parentId, paging, loadOptions) as UserList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new UserList GetByTreeParentIndex(string treeIndex, LoadOptions loadOptions = null)
        {
            return base.GetByTreeParentIndex(treeIndex, loadOptions) as UserList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new UserList GetByTreePId(object treePId, LoadOptions loadOptions = null)
        {
            return base.GetByTreePId(treePId, loadOptions) as UserList;
        }
