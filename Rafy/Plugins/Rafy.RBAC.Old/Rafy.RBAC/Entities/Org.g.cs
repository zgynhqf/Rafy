...
namespace Rafy.RBAC.Old
{
    ...
    partial class OrgRepository
    {
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new Org GetById(object id, LoadOptions loadOptions = null)
        {
            return base.GetById(id, loadOptions) as Org;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new Org GetFirst(LoadOptions loadOptions = null)
        {
            return base.GetFirst(loadOptions) as Org;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrgList GetAll(PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetAll(paging, loadOptions) as OrgList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrgList GetByIdList(object[] idList, LoadOptions loadOptions = null)
        {
            return base.GetByIdList(idList, loadOptions) as OrgList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrgList GetByParentIdList(object[] parentIdList, PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetByParentIdList(parentIdList, paging, loadOptions) as OrgList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrgList GetByParentId(object parentId, PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetByParentId(parentId, paging, loadOptions) as OrgList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrgList GetByTreeParentIndex(string treeIndex, LoadOptions loadOptions = null)
        {
            return base.GetByTreeParentIndex(treeIndex, loadOptions) as OrgList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrgList GetByTreePId(object treePId, LoadOptions loadOptions = null)
        {
            return base.GetByTreePId(treePId, loadOptions) as OrgList;
        }
