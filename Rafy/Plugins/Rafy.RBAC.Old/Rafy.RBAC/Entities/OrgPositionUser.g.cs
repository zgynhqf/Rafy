...
namespace Rafy.RBAC.Old
{
    ...
    partial class OrgPositionUserRepository
    {
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrgPositionUser GetById(object id, LoadOptions loadOptions = null)
        {
            return base.GetById(id, loadOptions) as OrgPositionUser;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrgPositionUser GetFirst(LoadOptions loadOptions = null)
        {
            return base.GetFirst(loadOptions) as OrgPositionUser;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrgPositionUserList GetAll(PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetAll(paging, loadOptions) as OrgPositionUserList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrgPositionUserList GetByIdList(object[] idList, LoadOptions loadOptions = null)
        {
            return base.GetByIdList(idList, loadOptions) as OrgPositionUserList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrgPositionUserList GetByParentIdList(object[] parentIdList, PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetByParentIdList(parentIdList, paging, loadOptions) as OrgPositionUserList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrgPositionUserList GetByParentId(object parentId, PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetByParentId(parentId, paging, loadOptions) as OrgPositionUserList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrgPositionUserList GetByTreeParentIndex(string treeIndex, LoadOptions loadOptions = null)
        {
            return base.GetByTreeParentIndex(treeIndex, loadOptions) as OrgPositionUserList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrgPositionUserList GetByTreePId(object treePId, LoadOptions loadOptions = null)
        {
            return base.GetByTreePId(treePId, loadOptions) as OrgPositionUserList;
        }
