...
namespace Rafy.RBAC.Old
{
    ...
    partial class ModuleACRepository
    {
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new ModuleAC GetById(object id, LoadOptions loadOptions = null)
        {
            return base.GetById(id, loadOptions) as ModuleAC;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new ModuleAC GetFirst(LoadOptions loadOptions = null)
        {
            return base.GetFirst(loadOptions) as ModuleAC;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new ModuleACList GetAll(PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetAll(paging, loadOptions) as ModuleACList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new ModuleACList GetByIdList(object[] idList, LoadOptions loadOptions = null)
        {
            return base.GetByIdList(idList, loadOptions) as ModuleACList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new ModuleACList GetByParentIdList(object[] parentIdList, PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetByParentIdList(parentIdList, paging, loadOptions) as ModuleACList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new ModuleACList GetByParentId(object parentId, PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetByParentId(parentId, paging, loadOptions) as ModuleACList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new ModuleACList GetByTreeParentIndex(string treeIndex, LoadOptions loadOptions = null)
        {
            return base.GetByTreeParentIndex(treeIndex, loadOptions) as ModuleACList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new ModuleACList GetByTreePId(object treePId, LoadOptions loadOptions = null)
        {
            return base.GetByTreePId(treePId, loadOptions) as ModuleACList;
        }
