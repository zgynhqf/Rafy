...
namespace Rafy.RBAC.Old
{
    ...
    partial class PositionRepository
    {
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new Position GetById(object id, LoadOptions loadOptions = null)
        {
            return base.GetById(id, loadOptions) as Position;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new Position GetFirst(LoadOptions loadOptions = null)
        {
            return base.GetFirst(loadOptions) as Position;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new PositionList GetAll(PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetAll(paging, loadOptions) as PositionList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new PositionList GetByIdList(object[] idList, LoadOptions loadOptions = null)
        {
            return base.GetByIdList(idList, loadOptions) as PositionList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new PositionList GetByParentIdList(object[] parentIdList, PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetByParentIdList(parentIdList, paging, loadOptions) as PositionList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new PositionList GetByParentId(object parentId, PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetByParentId(parentId, paging, loadOptions) as PositionList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new Position GetFirstBy(CommonQueryCriteria criteria)
        {
            return base.GetFirstBy(criteria) as Position;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new PositionList GetByTreeParentIndex(string treeIndex, LoadOptions loadOptions = null)
        {
            return base.GetByTreeParentIndex(treeIndex, loadOptions) as PositionList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new PositionList GetByTreePId(object treePId, LoadOptions loadOptions = null)
        {
            return base.GetByTreePId(treePId, loadOptions) as PositionList;
        }
