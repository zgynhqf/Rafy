...
namespace Rafy.Domain.ORM.DbMigration.Presistence
{
    ...
    partial class DbVersionRepository
    {
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new DbVersion GetById(object id, LoadOptions loadOptions = null)
        {
            return base.GetById(id, loadOptions) as DbVersion;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new DbVersion GetFirst(LoadOptions loadOptions = null)
        {
            return base.GetFirst(loadOptions) as DbVersion;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new DbVersionList GetAll(PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetAll(paging, loadOptions) as DbVersionList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new DbVersionList GetByIdList(object[] idList, LoadOptions loadOptions = null)
        {
            return base.GetByIdList(idList, loadOptions) as DbVersionList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new DbVersionList GetByParentIdList(object[] parentIdList, PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetByParentIdList(parentIdList, paging, loadOptions) as DbVersionList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new DbVersionList GetByParentId(object parentId, PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetByParentId(parentId, paging, loadOptions) as DbVersionList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new DbVersionList GetByTreeParentIndex(string treeIndex, LoadOptions loadOptions = null)
        {
            return base.GetByTreeParentIndex(treeIndex, loadOptions) as DbVersionList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new DbVersionList GetByTreePId(object treePId, LoadOptions loadOptions = null)
        {
            return base.GetByTreePId(treePId, loadOptions) as DbVersionList;
        }
