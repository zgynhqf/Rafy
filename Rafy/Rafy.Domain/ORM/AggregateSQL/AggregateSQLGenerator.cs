...
namespace Rafy.Domain
{
    ...
    internal class AggregateSQLGenerator
    {
        ...
        private void GenerateSelect()
        {
            ...
            //生成第一个直接查询的表的所有列
            var directlyQueryTableAlias = this.GetTableAlias(this._directlyQueryRepository.RdbDataProvider.DbTable.Name);
            ...
            {
                var tableName = item.PropertyEntityRepository.RdbDataProvider.DbTable.Name;
        ...
        {
            //From “第一个直接查询的表”
            var tableName = this._directlyQueryRepository.RdbDataProvider.DbTable.Name;
        ...
        private void GenerateOuterJoin()
        {
            ...
            do
            {
                ...
                {
                    pkTable = item.OwnerRepository.RdbDataProvider.DbTable;
                    fkTable = item.PropertyEntityRepository.RdbDataProvider.DbTable;
                ...
                {
                    pkTable = item.PropertyEntityRepository.RdbDataProvider.DbTable;
                    fkTable = item.OwnerRepository.RdbDataProvider.DbTable;
                    fkName = item.PropertyMeta.Name;
                }

                //当前的关系表的查找方法是固定的，就是属性实体。
                string propertyTableName = item.PropertyEntityRepository.RdbDataProvider.DbTable.Name;
        ...
        private void GenerateWhere()
        {
            ...
            else if (this._directlyQueryRepository.EntityMeta.EntityCategory == EntityCategory.Child)
            {
                ...
                var dqTableName = this._directlyQueryRepository.RdbDataProvider.DbTable.Name;
        ...
        {
            var table = this._directlyQueryRepository.RdbDataProvider.DbTable;
            ...
            do
            {
                ...
                var propertyTable = item.PropertyEntityRepository.RdbDataProvider.DbTable;
