...
{
    /// <summary>
    /// IRepositoryDataQueryAPI 对接 ORM 查询(<see cref="DbTable"/> )的实现。
    /// </summary>
    public abstract class DataQueryBase : IRepositoryDataQueryAPI
    {
        internal EntityRepository _repository;
        ...
        **********************************************************************/
        ...
        #region IRepositoryDataQueryAPI.Members

        IQueryable<TEntity> IRepositoryDataQueryAPI.CreateLinqQuery<TEntity>()
        {
            return this.CreateLinqQuery<TEntity>();
        }
        ...
        IQuery IRepositoryDataQueryAPI.ConvertToQuery(IQueryable queryable)
        {
            return this.ConvertToQuery(queryable);
        }
        ...
        EntityList IRepositoryDataQueryAPI.QueryList(SqlQueryArgs args)
        {
            return this.QueryList(args);
        }

        LiteDataTable IRepositoryDataQueryAPI.QueryTable(IQuery query, PagingInfo paging)
        {
