...
namespace OEA.Server.Hosts.WcfChannel
{
    /// <summary>
    ...
    public class DeleteRequest
    {
        ...
        [DataMember]
        private OEA.Server.DataPortalContext _context;
        ...
        public DeleteRequest(Type objectType, object criteria, OEA.Server.DataPortalContext context)
        {
        ...
        /// </summary>
        public OEA.Server.DataPortalContext Context
        {
            get { return _context; }
            set { _context = value; }
        }
