...
namespace OEA.Module.WPF.Command.Audit
{
    /// <summary>
    /// 清空日志
    /// </summary>
    [Command(CommandNames.ClearAuditLogCommand, TargetObjectType = typeof(AuditItem), ImageName = "Cleanup.bmp", Label = "清空日志",
         ToolTip = "清空日志", Index = CommandIndexs.ClearAuditLogCommand)]
