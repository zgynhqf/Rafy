...
namespace SimpleCsla.Validation
{
    ...
    public class RuleArgs
    {
        ...
        public RuleArgs(IManagedProperty propertyInfo)
            : this(propertyInfo.Name)
        {
            _propertyFriendlyName = propertyInfo.Name;
        }
        ...
        /// </para>
        /// </remarks>
        public RuleArgs(IManagedProperty propertyInfo, RuleSeverity severity)
            : this(propertyInfo)
        {
            _severity = severity;
        }
        ...
        /// </para>
        /// </remarks>
        public RuleArgs(IManagedProperty propertyInfo, RuleSeverity severity, bool stopProcessing)
