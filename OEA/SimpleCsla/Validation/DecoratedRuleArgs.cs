...
#if SILVERLIGHT
using Uri = SimpleCsla.Utilities;
#endif
...
namespace SimpleCsla.Validation
{
  ...
  public class DecoratedRuleArgs : RuleArgs
  {
    ...
    public DecoratedRuleArgs(IManagedProperty propertyInfo)
      : base(propertyInfo)
    {
      _decorations = new Dictionary<string, object>();
    }
    ...
    /// </para>
    /// </remarks>
    public DecoratedRuleArgs(IManagedProperty propertyInfo, RuleSeverity severity)
    ...
    /// </para>
    /// </remarks>
    public DecoratedRuleArgs(IManagedProperty propertyInfo, RuleSeverity severity, bool stopProcessing)
    ...
    /// <param name="args">Reference to a Dictionary containing 
    /// name/value arguments for use by the rule method.</param>
    public DecoratedRuleArgs(IManagedProperty propertyInfo, Dictionary<string, object> args)
      : base(propertyInfo)
    {
      _decorations = args;
    }
    ...
    /// </para>
    /// </remarks>
    public DecoratedRuleArgs(IManagedProperty propertyInfo, RuleSeverity severity, Dictionary<string, object> args)
      : base(propertyInfo, severity)
    {
      _decorations = args;
    }
    ...
    /// </para>
    /// </remarks>
    public DecoratedRuleArgs(IManagedProperty propertyInfo, RuleSeverity severity, bool stopProcessing, Dictionary<string, object> args)
      : base(propertyInfo, severity, stopProcessing)
    {
      _decorations = args;
    }
