...
namespace SimpleCsla.Validation
{
    ...
    public static class CommonRules
    {
        ...
        public static bool Required(object target, RuleArgs e)
        {
            object value = Utilities.CallByName(
              target, e.PropertyName, CallType.Get);
            if (null == value)
            {
                e.Description = string.Format("{0} 不可空白", RuleArgs.GetPropertyName(e));
                return false;
            }
            return true;
        }
        ...
        public class MaxLengthRuleArgs : DecoratedRuleArgs
        {
            ...
            /// <param name="maxLength">Max length of characters allowed.</param>
            public MaxLengthRuleArgs(IManagedProperty propertyInfo, int maxLength)
                : base(propertyInfo)
            {
                this["MaxLength"] = maxLength;
                this["Format"] = string.Empty;
            ...
            /// <param name="format">Format string for the max length
            /// value in the broken rule string.</param>
            public MaxLengthRuleArgs(IManagedProperty propertyInfo, int maxLength, string format)
                : base(propertyInfo)
            {
                this["MaxLength"] = maxLength;
                this["Format"] = format;
        ...
        public class MinLengthRuleArgs : DecoratedRuleArgs
        {
            ...
            /// <param name="minLength">min length of characters allowed.</param>
            public MinLengthRuleArgs(
              IManagedProperty propertyInfo, int minLength)
                : base(propertyInfo)
            {
                this["MinLength"] = minLength;
                this["Format"] = string.Empty;
            ...
            /// value in the broken rule string.</param>
            public MinLengthRuleArgs(
              IManagedProperty propertyInfo, int minLength, string format)
                : base(propertyInfo)
            {
                this["MinLength"] = minLength;
                this["Format"] = format;
        ...
        public class IntegerMaxValueRuleArgs : DecoratedRuleArgs
        {
            ...
            /// <param name="propertyInfo">Property to validate.</param>
            /// <param name="maxValue">Maximum allowed value for the property.</param>
            public IntegerMaxValueRuleArgs(IManagedProperty propertyInfo, int maxValue)
                : base(propertyInfo)
            {
                this["MaxValue"] = maxValue;
                this["Format"] = string.Empty;
            ...
            /// <param name="format">Format string for the max value
            /// value in the broken rule string.</param>
            public IntegerMaxValueRuleArgs(IManagedProperty propertyInfo, int maxValue, string format)
                : base(propertyInfo)
            {
                this["MaxValue"] = maxValue;
                this["Format"] = format;
        ...
        public class IntegerMinValueRuleArgs : DecoratedRuleArgs
        {
            ...
            /// <param name="propertyInfo">Property to validate.</param>
            /// <param name="minValue">Minimum allowed value for the property.</param>
            public IntegerMinValueRuleArgs(IManagedProperty propertyInfo, int minValue)
                : base(propertyInfo)
            {
                this["MinValue"] = minValue;
                this["Format"] = string.Empty;
            ...
            /// <param name="format">Format string for the min value
            /// value in the broken rule string.</param>
            public IntegerMinValueRuleArgs(IManagedProperty propertyInfo, int minValue, string format)
                : base(propertyInfo)
            {
                this["MinValue"] = minValue;
                this["Format"] = format;
        ...
        public class MaxValueRuleArgs<T> : DecoratedRuleArgs
        {
            ...
            /// <param name="propertyInfo">Property to validate.</param>
            /// <param name="maxValue">Maximum allowed value for the property.</param>
            public MaxValueRuleArgs(IManagedProperty propertyInfo, T maxValue)
                : base(propertyInfo)
            {
                this["MaxValue"] = maxValue;
                this["Format"] = string.Empty;
            ...
            /// <param name="format">Format string for the max value
            /// value in the broken rule string.</param>
            public MaxValueRuleArgs(IManagedProperty propertyInfo, T maxValue, string format)
                : base(propertyInfo)
            {
                this["MaxValue"] = maxValue;
                this["Format"] = format;
        ...
        public class MinValueRuleArgs<T> : DecoratedRuleArgs
        {
            ...
            /// <param name="propertyInfo">Property to validate.</param>
            /// <param name="minValue">Minimum allowed value for the property.</param>
            public MinValueRuleArgs(IManagedProperty propertyInfo, T minValue)
                : base(propertyInfo)
            {
                this["MinValue"] = minValue;
                this["Format"] = string.Empty;
            ...
            /// <param name="format">Format string for the min value
            /// value in the broken rule string.</param>
            public MinValueRuleArgs(IManagedProperty propertyInfo, T minValue, string format)
                : base(propertyInfo)
            {
                this["MinValue"] = minValue;
                this["Format"] = format;
        ...
        public static bool RegExMatch(object target, RuleArgs e)
        {
            ...
            if (!ruleSatisfied)
            {
                e.Description = String.Format("{0} does not match regular expression", RuleArgs.GetPropertyName(e));
                return false;
            }
            else
                return true;
        ...
        public class RegExRuleArgs : DecoratedRuleArgs
        {
            ...
            /// <param name="propertyInfo">Property to validate.</param>
            /// <param name="pattern">Built-in regex pattern to use.</param>
            public RegExRuleArgs(IManagedProperty propertyInfo, RegExPatterns pattern)
                : base(propertyInfo)
            {
                this["RegEx"] = new Regex(GetPattern(pattern));
                this["NullOption"] = NullResultOptions.ReturnFalse;
            ...
            /// <param name="propertyInfo">Property to validate.</param>
            /// <param name="pattern">Custom regex pattern to use.</param>
            public RegExRuleArgs(IManagedProperty propertyInfo, string pattern)
                : base(propertyInfo)
            {
                this["RegEx"] = new Regex(pattern);
                this["NullOption"] = NullResultOptions.ReturnFalse;
            ...
            /// <param name="propertyInfo">Property to validate.</param>
            /// <param name="regEx"><see cref="RegEx"/> object to use.</param>
            public RegExRuleArgs(IManagedProperty propertyInfo, System.Text.RegularExpressions.Regex regEx)
                : base(propertyInfo)
            {
                this["RegEx"] = regEx;
                this["NullOption"] = NullResultOptions.ReturnFalse;
            ...
            /// handled by the rule method.
            /// </param>
            public RegExRuleArgs(IManagedProperty propertyInfo, RegExPatterns pattern, NullResultOptions nullResult)
                : base(propertyInfo)
            {
                this["RegEx"] = new Regex(GetPattern(pattern));
                this["NullOption"] = nullResult;
            ...
            /// handled by the rule method.
            /// </param>
            public RegExRuleArgs(IManagedProperty propertyInfo, string pattern, NullResultOptions nullResult)
                : base(propertyInfo)
            {
                this["RegEx"] = new Regex(pattern);
                this["NullOption"] = nullResult;
            ...
            /// handled by the rule method.
            /// </param>
            public RegExRuleArgs(IManagedProperty propertyInfo, System.Text.RegularExpressions.Regex regEx, NullResultOptions nullResult)
                : base(propertyInfo)
            {
                this["RegEx"] = regEx;
                this["NullOption"] = nullResult;
