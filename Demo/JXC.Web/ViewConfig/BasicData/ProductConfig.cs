...
{
    internal class ProductConfig : WebViewConfig<Product>
    {
        protected override void ConfigView()
        {
            ...
            using (View.OrderProperties())
            {
                View.Property(Product.BianMaProperty)
                    .HasLabel("编码").ShowIn(ShowInWhere.All);
                View.Property(Product.MingChengProperty)
                    .HasLabel("名称").ShowIn(ShowInWhere.All);
                View.Property(Product.BarcodeProperty)
                    .HasLabel("条码").ShowIn(ShowInWhere.ListDetail);
                View.Property(Product.PictureProperty)
                    .HasLabel("图片").ShowIn(ShowInWhere.Detail);
                ...
                View.Property(Product.PingPaiProperty)
                    .HasLabel("品牌").ShowIn(ShowInWhere.ListDetail);
                ...
                View.Property(Product.BeiZhuProperty)
                    .HasLabel("备注").ShowIn(ShowInWhere.ListDetail);
