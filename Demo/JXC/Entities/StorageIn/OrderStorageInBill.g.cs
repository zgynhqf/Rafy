...
namespace JXC
{
    ...
    partial class OrderStorageInBillRepository
    {
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrderStorageInBill GetById(object id, LoadOptions loadOptions = null)
        {
            return base.GetById(id, loadOptions) as OrderStorageInBill;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrderStorageInBill GetFirst(LoadOptions loadOptions = null)
        {
            return base.GetFirst(loadOptions) as OrderStorageInBill;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrderStorageInBillList GetAll(PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetAll(paging, loadOptions) as OrderStorageInBillList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrderStorageInBillList GetByIdList(object[] idList, LoadOptions loadOptions = null)
        {
            return base.GetByIdList(idList, loadOptions) as OrderStorageInBillList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrderStorageInBillList GetByParentIdList(object[] parentIdList, PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetByParentIdList(parentIdList, paging, loadOptions) as OrderStorageInBillList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrderStorageInBillList GetByParentId(object parentId, PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetByParentId(parentId, paging, loadOptions) as OrderStorageInBillList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrderStorageInBillList GetByTreeParentIndex(string treeIndex, LoadOptions loadOptions = null)
        {
            return base.GetByTreeParentIndex(treeIndex, loadOptions) as OrderStorageInBillList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrderStorageInBillList GetByTreePId(object treePId, LoadOptions loadOptions = null)
        {
            return base.GetByTreePId(treePId, loadOptions) as OrderStorageInBillList;
        }
