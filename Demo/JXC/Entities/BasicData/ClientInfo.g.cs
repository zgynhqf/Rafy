...
namespace JXC
{
    ...
    partial class ClientInfoRepository
    {
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new ClientInfo GetById(object id, LoadOptions loadOptions = null)
        {
            return base.GetById(id, loadOptions) as ClientInfo;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new ClientInfo GetFirst(LoadOptions loadOptions = null)
        {
            return base.GetFirst(loadOptions) as ClientInfo;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new ClientInfoList GetAll(PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetAll(paging, loadOptions) as ClientInfoList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new ClientInfoList GetByIdList(object[] idList, LoadOptions loadOptions = null)
        {
            return base.GetByIdList(idList, loadOptions) as ClientInfoList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new ClientInfoList GetByParentIdList(object[] parentIdList, PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetByParentIdList(parentIdList, paging, loadOptions) as ClientInfoList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new ClientInfoList GetByParentId(object parentId, PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetByParentId(parentId, paging, loadOptions) as ClientInfoList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new ClientInfo GetFirstBy(CommonQueryCriteria criteria)
        {
            return base.GetFirstBy(criteria) as ClientInfo;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new ClientInfoList GetByTreeParentIndex(string treeIndex, LoadOptions loadOptions = null)
        {
            return base.GetByTreeParentIndex(treeIndex, loadOptions) as ClientInfoList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new ClientInfoList GetByTreePId(object treePId, LoadOptions loadOptions = null)
        {
            return base.GetByTreePId(treePId, loadOptions) as ClientInfoList;
        }
