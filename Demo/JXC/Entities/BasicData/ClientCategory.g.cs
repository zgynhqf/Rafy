...
namespace JXC
{
    ...
    partial class ClientCategoryRepository
    {
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new ClientCategoryList GetBy(CommonQueryCriteria criteria)
        {
            return base.GetBy(criteria) as ClientCategoryList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new ClientCategory GetFirstBy(CommonQueryCriteria criteria)
        {
            return base.GetFirstBy(criteria) as ClientCategory;
        }
