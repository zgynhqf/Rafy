...
namespace OEA.MetaModel.View
{
    ...
    public class SelectionViewMeta : Freezable
    {
        ...
        public Type RefEntityType
        {
            get
            {
                ...
                return this._RefEntityType;
            }
            set
            {
                this._RefInfo = null;

                this.SetValue(ref this._RefEntityType, value);
            }
        }
        ...
        public EntityViewMeta RefTypeDefaultView
        {
            get
            {
                ...
                {
                    this._RefTypeDefaultView = UIModel.Views.CreateBaseView(this.RefEntityType);
                }
    ...
    /// <param name="selected">被选择的实体列表，Count 的范围是自然数。</param>
