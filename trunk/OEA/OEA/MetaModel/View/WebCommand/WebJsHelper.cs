...
namespace OEA.MetaModel
{
    ...
    /// js 文件帮助类。
    /// </summary>
    public static class WebJsHelper
    {
        /// <summary>
        /// 匹配 js 中定义的类名
        /// </summary>
        ...
        /// </summary>
        private static readonly string[] JsBlocksSplitter = new string[] { "//block end" };
        ...
        public static void LoadJsBlocks(string jsContent, List<JsBlock> list)
        {
            //可以使用 “//block end” 来分隔多个命令，方便在一个文件中定义多个命令
