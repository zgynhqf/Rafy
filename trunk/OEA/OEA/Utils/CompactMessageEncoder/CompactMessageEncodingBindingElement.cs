...
namespace Amib.WCF
{
    public class CompactMessageEncodingBindingElement : MessageEncodingBindingElement
    {
        /// <summary>
        ...
        public CompactMessageEncodingBindingElement()
        {
        }
        ...
        {
            SetInnerBindingElement(originalBindingElement.InnerBindingElement);
        ...
        /// </summary>
        internal void SetInnerBindingElement(MessageEncodingBindingElement innerBindingElement)
        {
            _innerBindingElement = innerBindingElement;
        }
