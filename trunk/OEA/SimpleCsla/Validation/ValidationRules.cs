...
namespace SimpleCsla.Validation
{
  ...
  [System.Diagnostics.DebuggerStepThrough]
    ...
    public partial class ValidationRules : MobileObject
    {
        ...
        /// </param>
        public void AddRule(RuleHandler handler, IManagedProperty propertyInfo)
        {
        ...
        /// The priority of the rule, where lower numbers are processed first.
        /// </param>
        public void AddRule(RuleHandler handler, IManagedProperty propertyInfo, int priority)
        {
            ValidateHandler(handler);
        ...
        /// The PropertyInfo object describing the property.
        /// </param>
        public void AddRule<T>(RuleHandler<T, RuleArgs> handler, IManagedProperty propertyInfo)
        {
            ValidateHandler(handler);
        ...
        /// The priority of the rule, where lower numbers are processed first.
        /// </param>
        public void AddRule<T>(RuleHandler<T, RuleArgs> handler, IManagedProperty propertyInfo, int priority)
        {
            ValidateHandler(handler);
        ...
        /// with that property.
        /// </remarks>
        public void AddDependentProperty(IManagedProperty propertyInfo, IManagedProperty dependentPropertyInfo)
        {
        ...
        /// </remarks>
        public void AddDependentProperty(IManagedProperty propertyInfo, IManagedProperty dependentPropertyInfo, bool isBidirectional)
        {
        ...
        /// </param>
        public void CheckRules(IManagedProperty propertyInfo)
        {
            ...
            for (int index = 0; index < list.Count; index++)
            {
                ...
                else
                {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        throw new ValidationException("Properties.Resources.ValidationRulesException" + rule.RuleArgs.PropertyName + rule.RuleName, ex);
                    }
