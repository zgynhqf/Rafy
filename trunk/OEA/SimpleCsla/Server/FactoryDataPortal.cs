...
namespace SimpleCsla.Server
{
    ...
    public class FactoryDataPortal : IDataPortalServer
    {
        ...
        private DataPortalResult InvokeMethod(string factoryTypeName, string methodName, DataPortalContext context)
        {
            ...
            SimpleCsla.Reflection.MethodCaller.CallMethodIfImplemented(factory, "Invoke", context);
            object result = null;
            try
            {
                result = SimpleCsla.Reflection.MethodCaller.CallMethod(factory, methodName);
                SimpleCsla.Reflection.MethodCaller.CallMethodIfImplemented(factory, "InvokeComplete", context);
            }
            catch (Exception ex)
            {
                SimpleCsla.Reflection.MethodCaller.CallMethodIfImplemented(factory, "InvokeError", ex);
                throw;
            }
        ...
        private DataPortalResult InvokeMethod(string factoryTypeName, string methodName, object e, DataPortalContext context)
        {
            ...
            try
            {
                result = SimpleCsla.Reflection.MethodCaller.CallMethod(factory, methodName, e);
                SimpleCsla.Reflection.MethodCaller.CallMethodIfImplemented(factory, "InvokeComplete", context);
            }
            catch (Exception ex)
            {
