...
namespace SimpleCsla
{
  ...
  /// during the server-side DataPortal invocSerializationInfoation.
  /// </summary>
  ...
  public class DataPortalException : Exception
  {
    ...
    /// <see cref="SimpleCsla.Server.DataPortalException"/>, which 
    /// is then wrapped in a 
    /// <see cref="SimpleCsla.DataPortalException"/>. This property
