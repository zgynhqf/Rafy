...
namespace OEA.Module.WPF.Automation
{
    /// <summary>
    /// 自动化帮助类
    /// </summary>
    public static class AutomationHelper
    {
        ...
        {
            meta.SetCustomParams(AutomationPropertyKey, property.GetMetaPropertyName(meta.EntityType));
        }
        ...
        {
            var autoProperty = evm.TryGetCustomParams<string>(AutomationPropertyKey);
