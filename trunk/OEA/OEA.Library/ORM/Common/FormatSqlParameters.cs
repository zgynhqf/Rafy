...
namespace OEA.ORM
{
    ...
    /// FormatSql 中的参数列表封装
    /// </summary>
    public class FormatSqlParameters
    {
        ...
        /// <returns></returns>
        internal int AddParameter(object value)
        {
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        internal void AddParameter(StringBuilder sql, object value)
        {
            this._parameters.Add(value);
        ...
        internal void AddParameter(TextWriter sql, object value)
        {
            this._parameters.Add(value);
        ...
        /// </summary>
        /// <returns></returns>
        public static implicit operator object[](FormatSqlParameters value)
        {
