...
{
    public class SqlTable : DbTable
    {
        public SqlTable(EntityMeta meta, string name) : base(meta, name) { }
        ...
        public override int Insert(IDb db, IEntity item)
        {
            ...
            {
                var value = db.DBA.QueryValueNormal("SELECT @@identity;", CommandType.Text);
