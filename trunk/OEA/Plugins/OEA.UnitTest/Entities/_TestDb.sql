...
/****** Object:  Database [OEAUnitTest]    Script Date: 11/11/2011 13:50:54 ******/
IF  EXISTS (SELECT name FROM sys.databases WHERE name = N'OEAUnitTest')
DROP DATABASE [OEAUnitTest]
GO
