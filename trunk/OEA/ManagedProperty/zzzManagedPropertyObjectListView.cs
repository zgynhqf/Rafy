...
//{
//    public class ManagedPropertyObjectListView : BindingList<ManagedPropertyObjectView>
//    {
//        /// <summary>
...
//            foreach (var item in this._cacheOldList) { this.Add(new ManagedPropertyObjectView(item)); }
