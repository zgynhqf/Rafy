...
//    {
//        private Action<ListLogicalView>[] _actions;
...
//        protected void PrepareActions(params Action<ListLogicalView>[] actions)
//        {
...
//            (control.MainView as ListLogicalView).IsReadOnly = true;
...
//        //    var controlResult = AutoUI.ViewFactory.CreateListLogicalView(testType);
...
//        public override void Execute(ListLogicalView view)
//        {
//            var controlResult = AutoUI.ViewFactory.CreateListLogicalView(typeof(NormItem));
