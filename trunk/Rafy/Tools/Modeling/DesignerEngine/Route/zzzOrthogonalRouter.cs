...
//{
//    internal class OrthogonalRouter : Router
//    {
//        private const int _margin = 20;

//        internal override List<Point> Route(ConnectorInfo source, System.Windows.Point sinkPoint, ConnectorOrientation preferredOrientation)
//        {
...
//            if (preferredOrientation != ConnectorOrientation.Center)
...
//        internal override List<Point> Route(ConnectorInfo source, ConnectorInfo sink)
//        {
//            List<Point> linePoints = new List<Point>();
...
//            CheckPathEnd(source, sink, linePoints);
//            return linePoints;
//        }
...
//        {
//            Rect rect = connectorThumb.DesignerItemRect;
...
//        private static void CheckPathEnd(ConnectorInfo source, ConnectorInfo sink, List<Point> linePoints)
//        {
