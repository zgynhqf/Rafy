...
{
    internal class UserLoginLogConfig : WPFViewConfig<UserLoginLog>
    {
        protected override void ConfigView()
        {
            View.DomainName("用户登录记录").DisableEditing();
            View.RemoveCommands(
                WPFCommandNames.PopupAdd, WPFCommandNames.Cancel, WPFCommandNames.Delete, WPFCommandNames.SaveList
                );
