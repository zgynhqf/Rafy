...
namespace MP
{
    ...
    partial class MonthPlanRepository
    {
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new MonthPlanList GetByParentIdList(object[] parentIdList, PagingInfo paging = null, EagerLoadOptions eagerLoad = null)
        {
            return base.GetByParentIdList(parentIdList, paging, eagerLoad) as MonthPlanList;
        }
