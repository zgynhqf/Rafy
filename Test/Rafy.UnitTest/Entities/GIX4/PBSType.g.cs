...
namespace UT
{
    ...
    partial class PBSTypeRepository
    {
        ...
        [DebuggerStepThrough]
        private new PBSType FetchFirst(params object[] parameters)
        {
            return base.FetchFirst(parameters) as PBSType;
        }
        ...
        [DebuggerStepThrough]
        private new PBSTypeList FetchList(params object[] parameters)
        {
            return base.FetchList(parameters) as PBSTypeList;
        }
        ...
        [DebuggerStepThrough]
        protected int FetchCount(Expression<Func<PBSTypeRepository, EntityList>> dataQueryExp)
        {
            return this.FetchCount<PBSTypeRepository>(dataQueryExp);
        }
        ...
        [DebuggerStepThrough]
        private PBSType FetchFirst(Expression<Func<PBSTypeRepository, EntityList>> dataQueryExp)
        {
            return this.FetchFirst<PBSTypeRepository>(dataQueryExp) as PBSType;
        }
        ...
        /// <returns>返回满足条件的实体列表。</returns>
        [DebuggerStepThrough]
        private PBSTypeList FetchList(Expression<Func<PBSTypeRepository, EntityList>> dataQueryExp)
        {
            return this.FetchList<PBSTypeRepository>(dataQueryExp) as PBSTypeList;
        }
        ...
        [DebuggerStepThrough]
        private LiteDataTable FetchTable(Expression<Func<PBSTypeRepository, LiteDataTable>> dataQueryExp)
        {
            return this.FetchTable<PBSTypeRepository>(dataQueryExp);
        }
