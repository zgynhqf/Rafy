...
namespace UT
{
    ...
    partial class MerchantItemRepository
    {
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new MerchantItem GetById(object id, LoadOptions loadOptions = null)
        {
            return base.GetById(id, loadOptions) as MerchantItem;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new MerchantItem GetFirst(LoadOptions loadOptions = null)
        {
            return base.GetFirst(loadOptions) as MerchantItem;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new MerchantItemList GetAll(PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetAll(paging, loadOptions) as MerchantItemList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new MerchantItemList GetByIdList(object[] idList, LoadOptions loadOptions = null)
        {
            return base.GetByIdList(idList, loadOptions) as MerchantItemList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new MerchantItemList GetByParentIdList(object[] parentIdList, PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetByParentIdList(parentIdList, paging, loadOptions) as MerchantItemList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new MerchantItemList GetByParentId(object parentId, PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetByParentId(parentId, paging, loadOptions) as MerchantItemList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new MerchantItemList GetByTreeParentIndex(string treeIndex, LoadOptions loadOptions = null)
        {
            return base.GetByTreeParentIndex(treeIndex, loadOptions) as MerchantItemList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new MerchantItemList GetByTreePId(object treePId, LoadOptions loadOptions = null)
        {
            return base.GetByTreePId(treePId, loadOptions) as MerchantItemList;
        }
