...
namespace UT
{
    ...
    partial class FolderRepository
    {
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new Folder GetById(object id, LoadOptions loadOptions = null)
        {
            return base.GetById(id, loadOptions) as Folder;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new Folder GetFirst(LoadOptions loadOptions = null)
        {
            return base.GetFirst(loadOptions) as Folder;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new FolderList GetAll(PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetAll(paging, loadOptions) as FolderList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new FolderList GetByIdList(object[] idList, LoadOptions loadOptions = null)
        {
            return base.GetByIdList(idList, loadOptions) as FolderList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new FolderList GetByParentIdList(object[] parentIdList, PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetByParentIdList(parentIdList, paging, loadOptions) as FolderList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new FolderList GetByParentId(object parentId, PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetByParentId(parentId, paging, loadOptions) as FolderList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new FolderList GetByTreeParentIndex(string treeIndex, LoadOptions loadOptions = null)
        {
            return base.GetByTreeParentIndex(treeIndex, loadOptions) as FolderList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new FolderList GetByTreePId(object treePId, LoadOptions loadOptions = null)
        {
            return base.GetByTreePId(treePId, loadOptions) as FolderList;
        }
