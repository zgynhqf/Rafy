...
{
    public abstract class AccountsPluginTest : CommonTestBase
    {
        public static void APT_ClassInitialize_Base()
        {
            RafyEnvironment.LoadPlugin(typeof(UserRepository).Assembly);
        }

        //[TestMethod]
        //public virtual void APT_Transaction_IsolationLevel()
        //{
        //    var repo = RF.ResolveInstance<UserRepository>();
        //    //using (AutoClearRepoData(repo))
        //    //{
        ...
        //        using(var tran = AutoClearRepoData(db, level))
        //        {
        //            while(!let1Start)
        //            {
        //                Thread.Sleep(1000);
        ...
        public virtual void APT_Register_Success()
        {
            var repo = RF.ResolveInstance<UserRepository>();
            using (AutoClearRepoData(repo))
            {
        ...
        public virtual void APT_Register_Validate_Password()
        {
            var repo = RF.ResolveInstance<UserRepository>();
            using (AutoClearRepoData(repo))
            {
        ...
        public virtual void APT_Register_Identity_UserName()
        {
            var repo = RF.ResolveInstance<UserRepository>();
            using (AutoClearRepoData(repo))
            {
        ...
        public virtual void APT_Register_Identity_Email()
        {
            var repo = RF.ResolveInstance<UserRepository>();
            using (AutoClearRepoData(repo))
            {
        ...
        public virtual void APT_Register_Identity_EmailAndUserName()
        {
            var repo = RF.ResolveInstance<UserRepository>();
            using (AutoClearRepoData(repo))
            {
        ...
        public virtual void APT_Login_Success_Email()
        {
            var repo = RF.ResolveInstance<UserRepository>();
            using (AutoClearRepoData(repo))
            {
        ...
        public virtual void APT_Login_Success()
        {
            var repo = RF.ResolveInstance<UserRepository>();
            using (AutoClearRepoData(repo))
            {
        ...
        public virtual void APT_Login_Failed()
        {
            var repo = RF.ResolveInstance<UserRepository>();
            using (AutoClearRepoData(repo))
            {
                ...
                var res = controller.LoginByUserName("hqf", "hqf1", out var user);
                Assert.IsFalse(res.Success);
                Assert.IsNotNull(user);
        ...
        public virtual void APT_Login_Failed_MaxLoginTimes()
        {
            var repo = RF.ResolveInstance<UserRepository>();
            using (AutoClearRepoData(repo))
            {
        ...
        public virtual void APT_Login_Failed_UserDisabled()
        {
            var repo = RF.ResolveInstance<UserRepository>();
            using (AutoClearRepoData(repo))
            {
