...
namespace UT
{
    ...
    partial class TestTreeTaskRepository
    {
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new TestTreeTask GetById(object id, LoadOptions loadOptions = null)
        {
            return base.GetById(id, loadOptions) as TestTreeTask;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new TestTreeTask GetFirst(LoadOptions loadOptions = null)
        {
            return base.GetFirst(loadOptions) as TestTreeTask;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new TestTreeTaskList GetAll(PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetAll(paging, loadOptions) as TestTreeTaskList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new TestTreeTaskList GetByIdList(object[] idList, LoadOptions loadOptions = null)
        {
            return base.GetByIdList(idList, loadOptions) as TestTreeTaskList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new TestTreeTaskList GetByParentIdList(object[] parentIdList, PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetByParentIdList(parentIdList, paging, loadOptions) as TestTreeTaskList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new TestTreeTaskList GetByParentId(object parentId, PagingInfo paging = null, LoadOptions loadOptions = null)
        {
            return base.GetByParentId(parentId, paging, loadOptions) as TestTreeTaskList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new TestTreeTaskList GetByTreeParentIndex(string treeIndex, LoadOptions loadOptions = null)
        {
            return base.GetByTreeParentIndex(treeIndex, loadOptions) as TestTreeTaskList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new TestTreeTaskList GetByTreePId(object treePId, LoadOptions loadOptions = null)
        {
            return base.GetByTreePId(treePId, loadOptions) as TestTreeTaskList;
        }
